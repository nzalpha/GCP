# *Instance Templates*
To create group of same configuration vm  we use instance templates.
1. Two types of Instane Templates
   - Regional Templates: If the template is created in one particular region, vm will be created in that region.
   - Global Templates: Templates created at one region can be used anywhere in the project in any region
